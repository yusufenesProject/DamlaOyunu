...
public class SetColor_Orta
{
	...
	public int k1ort , k2ort , k3ort , k4ort;
	public int k1,k2,k3,k4;
	public int eskimerkez1,eskimerkez2,eskimerkez3,eskimerkez4;
	public int sayac = 0;
	...
	{
		int fark1, fark2, fark3,fark4;
		fark1 = Mathf.Abs(k1 - eleman);
		fark2 = Mathf.Abs(k2 - eleman);
		fark3 = Mathf.Abs(k3 - eleman);
		fark4 = Mathf.Abs(k4 - eleman);
		if (fark1 < fark2 && fark1 < fark3 && fark1 < fark4)
		{
			kume_1.Add(eleman);	
			
		}
		else if (fark2 < fark1 && fark2 < fark3 && fark2< fark4)
		{
			kume_2.Add (eleman);
			
		}
		else if (fark3 < fark2 && fark3 < fark1 && fark3 < fark4)
		{
			kume_3.Add(eleman);
			
		}
		else if(fark4 < fark1 && fark4 < fark2 && fark4 < fark3 )
		{
			kume_4.Add(eleman);
		}
	}
